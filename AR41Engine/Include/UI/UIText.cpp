...
CUIText::CUIText(const CUIText& Button) :
    CUIWidget(Button)
{
    ...
    m_Transparency = Button.m_Transparency;
    m_Opacity = Button.m_Opacity;
    m_Color = Button.m_Color;

    m_ShadowEnable = Button.m_ShadowEnable;
    m_ShadowBrush = Button.m_ShadowBrush;
    m_ShadowTransparency = Button.m_ShadowTransparency;
    m_ShadowOpacity = Button.m_ShadowOpacity;
    m_ShadowColor = Button.m_ShadowColor;
    m_ShadowOffset = Button.m_ShadowOffset;
    m_AlignH = Button.m_AlignH;
    m_AlignV = Button.m_AlignV;

    m_TextCapacity = Button.m_TextCapacity;
    m_TextCount = Button.m_TextCount;

    m_Text = new TCHAR[m_TextCapacity];

    lstrcpy(m_Text, Button.m_Text);
