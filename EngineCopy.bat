...
xcopy .\AR41Engine\Bin\*.* .\Engine\Bin\ /d /s /y /i /exclude:EngineCopyExclude.txt
xcopy .\AR41Engine\Bin\*.* .\AR41Editor\Bin\ /d /s /y /i /exclude:EngineCopyExclude.txt
xcopy .\AR41Engine\Bin\*.* .\Client2D\Bin\ /d /s /y /i /exclude:EngineCopyExclude.txt
xcopy .\AR41Engine\Bin\*.* .\Client3D\Bin\ /d /s /y /i /exclude:EngineCopyExclude.txt
